...
public class VoucherRedeem {
    ...
    public void voucherRedeem() throws Exception {
		...
		genericFunction.logFunction(logFileName,":::::::::[voucherRedeem(Scheduler Process)]:::::::::::::::::");
		...
		genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::::::::query to fetch the transaction details from TRANSACTION_MAST :::::::::::"+query);
		...
		{	
			genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]::::::::::transaction:::::::::::::"+transaction);
			 ...
			 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::query to update TRANSACTION_MAST(STATUS=1):::::::::"+query);
			 
			 try {
				 isRecordUpdated = namedDbJdbcTemplate.update(query,params)>0;
				 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::isRecordUpdated in TRANSACTION_MAST(STATUS=1):::::::::"+isRecordUpdated);
			 }
			 catch(Exception e)
			 {
				 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::Exception in recordUpdate to TRANSACTION_MAST:::::::"+e.getMessage());
			 ...
			 if(isRecordUpdated)
			 {
				 ...
				 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::query to update TRANSACTION_DET(TRANS_TYPE=1):::::::::"+query);
				 
				 try {
					 isRecordUpdated = namedDbJdbcTemplate.update(query,params)>0;
					 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::isRecordUpdated in TRANSACTION_DET(TRANS_TYPE=1):::::::::"+isRecordUpdated);
				 }
				 catch(Exception e)
				 {
					 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::Exception in recordUpdate to TRANSACTION_DET(TRANS_TYPE=1):::::::"+e.getMessage());
					 throw new Exception("1004");
				 }
			 }
			 ...
			 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::query to fetch details from TRANSACT_DET(TRANS_TYPE=1):::::::::"+query);
			 ...
			 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]::::::::::transactionDetDetails:::::::::::::::::::"+transactionDetDetails);
			 ...
			 { 
				 ...
				 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::::::::::::rechargeDetails:::::::::::::"+rechargeDetails);
			     ...
			     genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::centCovertFactor:::::::::"+centCovertFactor);
			     genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::serviceUnitT:::::::::::::"+serviceUnitT);
			 ...
			 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::::::::::transaction::::::::::::::"+transaction.getMsisdn());
			 creditRequest(transaction,subTransactionId,serviceHash,rechargeDetails);
			 genericFunction.logFunction(logFileName,"[voucherRedeem(Scheduler Process)]:::::::::::::::serviceHash::::::::::::::"+serviceHash);
		}
	}
	...
	public ICPResponseMapper creditRequest(TransactionMast transactionMastDetails,long subTransactionId,HashMap<String,String> serviceHash,String rechargeDetails) throws Exception
	{
		...
		genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)] ::::::::::::::CREDIT REQUEST::::::::::");
		genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)] :::::::::::::::transactionMastDetails:::::::::"+transactionMastDetails);
		genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)] :::::::::::::::subTransactionId::::::::::"+subTransactionId);
		genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)] :::::::::::::;:serviceHash::::::::::::::::::::"+serviceHash);
		genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)] ::::::::::::rechargeDetails:::::::::::::::"+rechargeDetails);
	    
	    String query="",refNos="",errorCode="",status="",desc="",ocsRespTxn="",accountVal="",ivrBalanceInfo="",expiry1="";
	   
	    String respCode="",ussdMsg=successMessage,newBalanceStr="",balanceString="",balanceDetails="",messageId="",voucherStatus="";
	    int validFlag= 0, mastStatus=1, intStatus = 0,centCovertFactor=1,bonusRequestCount=0;
	    float newBalance = 0;
        ...
        genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::::::::::::MSISDN::::::::::::::::"+transactionMastDetails.getMsisdn());
	    ...
	    if(responseMapper.getIcpResponse().getDescription().contains("500 read timeout") || responseMapper.getIcpResponse().getDescription().contains("timeout"))
	    {
             ...
             intStatus =4;
             respCode ="1009";
             genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::Voucher_redeem TRANSACTIONID : "+subTransactionId+"DESTMSISDN : "+transactionMastDetails.getMsisdn() +"VOUCHERPIN :"+transactionMastDetails.getVoucherNumber()+"DESCRIPTION : TIMEOUT FROM ICP  EVENTTYPE:1 EVENTDESC : REDEEM REQMODE:"+transactionMastDetails.getRequestMode() +"STATUS : 2");
	    }
	    else if(responseMapper.getIcpResponse().getDescription().contains("500 Can't connect") || responseMapper.getIcpResponse().getDescription().contains("Internal Server Error") || responseMapper.getIcpResponse().getDescription().contains("404 Not FoundConnection") || responseMapper.getIcpResponse().getDescription().contains("Failed - System Error"))
	    {
            ...
            genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::Voucher_redeem TRANSACTIONID : "+subTransactionId+"DESTMSISDN : "+transactionMastDetails.getMsisdn() +"VOUCHERPIN :"+transactionMastDetails.getVoucherNumber()+"DESCRIPTION : CONNECTION ERROR  EVENTTYPE:10 EVENTDESC : REDEEM:"+transactionMastDetails.getRequestMode() +"STATUS : 3");
	    ...
	    else
	    {
	    	...
	    	{
	    		genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::Voucher_redeem TRANSACTIONID : "+subTransactionId+"::::::::::::Valid JSON Response:::::::::::");
	    		...
	    		{	
	    			...
	    			genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::ocsRespTxn:::::::::::"+ocsRespTxn);
	    			genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::errorCode::::::::::::"+errorCode);
	    			genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::status:::::::::::::::"+status);
	    			genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::desc:::::::::::::::::"+desc);
	    			
	    			List<BalanceInfo> balance  = responseMapper.getBalances();
	    			
	    			genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::ussdMsg::::::::::"+ussdMsg);
	    			
	    			ussdMsg = ussdMsg.replaceAll("__FACEVALUE__",String.valueOf(transactionMastDetails.getVoucherAmount()));
	    		
	    			genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::ussdMsg after replace::::::::::"+ussdMsg);
	    			
	    			genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::balance list ::::::::::::::"+balance);
	    			for(BalanceInfo b:balance)
	    			{	
	    				
	    				genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::balance::::::::::"+balance);
	    				if(bucketIdFactorInHash.containsKey(String.valueOf(b.getId())))
	    				{	
	    					centCovertFactor=b.getId(); 
	    				}
	    				newBalance = b.getNewBalance() / centCovertFactor;			
	    				...
	    				genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::balanceDetails::::::"+balanceDetails);
	    				genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::ivrBalanceInfo::::::"+ivrBalanceInfo);
	    				genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::Voucher_redeem TRANSACTIONID : "+subTransactionId+"DESTMSISDN : "+transactionMastDetails.getMsisdn() +"VOUCHERPIN :"+transactionMastDetails.getVoucherNumber()+" DESCRIPTION : SUCCESS JSON RESPONSE  EVENTTYPE:10 EVENTDESC : REDEEM:"+transactionMastDetails.getRequestMode() +"STATUS : 1");
	    		...
	    		{	
	    			genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::::::::FAILED STATUS:::::::::::::::::::::::");
	    			intStatus =3;
	    			respCode ="1014";
	    			
	    			genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::Voucher_redeem TRANSACTIONID : "+subTransactionId+"DESTMSISDN : "+transactionMastDetails.getMsisdn() +"VOUCHERPIN :"+transactionMastDetails.getVoucherNumber()+" DESCRIPTION : FAILURE JSON RESPONSE  EVENTTYPE:10 EVENTDESC : REDEEM:"+transactionMastDetails.getRequestMode() +"STATUS : 3");
	    ...
	    genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::::query to check in transaction_det, whether any bonus request is present::::::"+query);
	    try 
	    {
	    ...
	    {
	    	 bonusRequestCount = 0;
	    	 genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::Exception in select query:::::::::"+e.getMessage());	
	    }
	    ...
	    genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::::messageId:::::::"+messageId+":::::::voucherStatus:::::"+voucherStatus+"::::::mastStatus:::::::::"+mastStatus);
	    
	    if(bonusRequestCount == 0 )
        {
	    	  mastStatus= Integer.parseInt(statusCombo.get(String.valueOf(intStatus)));
	    	  genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]::::::Voucher_redeem TRANSACTIONID : "+subTransactionId+"::::::::transaction mast status:"+mastStatus+"::::::Status changed as there is no bonus::::::");
        }	
	    ...
	    genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::::query to update TRANSACTION_MAST::::::::::"+query);
	    
	    try {
	    	isRecordUpdated = namedDbJdbcTemplate.update(query, params)>0;
	    	genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::isRecordUpdated into TRANSACTION_MAST:::::::::"+isRecordUpdated);
	    }
	    catch(Exception e)
	    {
	    	genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::Exception in updating record into TRANSACTION_MAST table::::::::"+e.getMessage());
	    }
	    ...
	    genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::::intStatus::::::::::"+String.valueOf(intStatus));
	    genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::::respCode:::::::::::"+respCode);
	    genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::::responseDescription::::::::::"+String.valueOf(responseMapper.getAppTxnRefId()));
	    genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::::transactionId::::::::::"+String.valueOf(subTransactionId));
	    ...
	    genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::::query to update TRANSACTION_DET::::::::::"+query);
	    
	    try {
	    	isRecordUpdated = namedDbJdbcTemplate.update(query, params)>0;
	    	genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::isRecordUpdated into TRANSACTION_DET:::::::::"+isRecordUpdated);
	    }
	    catch(Exception e)
	    {
	    	genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::Exception in updating record into TRANSACTION_DET table::::::::"+e.getMessage());
	    }
	    ...
	    genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::::query to update VOUCHER_DET::::::::::"+query);
	    
	    try {
	    	isRecordUpdated = namedDbJdbcTemplate.update(query, params)>0;
	    	genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::isRecordUpdated into VOUCHER_DET:::::::::"+isRecordUpdated);
	    }
	    catch(Exception e)
	    {
	    	genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::Exception in updating record into VOUCHER_DET table::::::::"+e.getMessage());
	    }
	    ...
	    {	
	    	...
	    	genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::::query to insert into WVMS_TRANSACTION_MESSAGES::::::::::"+query);
	 	    
	 	    try {
	 	    	isRecordInserted = namedDbJdbcTemplate.update(query, params)>0;
	 	    	genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::isRecordInserted into WVMS_TRANSACTION_MESSAGES:::::::::"+isRecordUpdated);
	 	    }
	 	    catch(Exception e)
	 	    {
	 	    	genericFunction.logFunction(logFileName,"[voucherRedeem(creditRequest)]:::::Exception in inserting record into WVMS_TRANSACTION_MESSAGES table::::::::"+e.getMessage());
	 	    }
